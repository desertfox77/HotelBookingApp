...
public class NEO extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, OnMapReadyCallback {
    int abc ;
    GoogleMap map;
            ...
            public void onClick(View v) {
                if(sherrile==1 && sheren==1){
                    ...
                    if(adddata == true){
                        ...
                        Intent japan = new Intent(NEO.this, mainhome.class);
                        startActivity(japan);
                        ...
                        if(isMessageAllowed(Manifest.permission.SEND_SMS)){
                            ...
                            Toast.makeText(NEO.this, "Success Book and Message", Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(NEO.this, "Permission Denied", Toast.LENGTH_SHORT).show();
                        }
                    }
