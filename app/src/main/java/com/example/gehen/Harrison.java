...
public class Harrison extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, OnMapReadyCallback {
    int abc ;
    GoogleMap map;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_harrison);
            ...
            public void onClick(View v) {
                if(sherrile==1 && sheren==1){
                    ...
                    if(adddata == true){
                        ...
                        Intent japan = new Intent(Harrison.this, mainhome.class);
                        startActivity(japan);
                        ...
                        if(isMessageAllowed(Manifest.permission.SEND_SMS)){
                            ...
                            Toast.makeText(Harrison.this, "Success Book and Message", Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(Harrison.this, "Permission Denied", Toast.LENGTH_SHORT).show();
                        }
                    }
